                  ...
                  <div class="card-block">
                    ...
                    <div class="align-middle mb-25">
                      ...
                      <div class="d-inline-block">
                        <a href="#!"><h6>Alex Thompson</h6></a>
                        <p class="text-muted mb-0">Cheers!</p>
                        <span class="status deactive text-mute"
                          ><i class="far fa-clock mr-10"></i>30 min ago</span
                        >
                      </div>
                    </div>
                    <div class="align-middle mb-25">
                      ...
                      <div class="d-inline-block">
                        ...
                        <p class="text-muted mb-0">Cheers!</p>
                        <span class="status deactive text-mute"
                          ><i class="far fa-clock mr-10"></i>10 min ago</span
                        >
                      </div>
                    </div>
                  </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="#!"
                                ><i
                                  class="ik ik-edit f-16 mr-15 text-green"
                                ></i></a
                              ><a href="#!"
                                ><i class="ik ik-trash-2 f-16 text-red"></i
                              ></a>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="text-right">
                              <h6 class="fw-700">
                                $78.001<i
                                  class="fas fa-level-down-alt text-red ml-10"
                                ></i>
                              </h6>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td class="text-right">
                              <h6 class="fw-700">
                                $89.051<i
                                  class="fas fa-level-up-alt text-green ml-10"
                                ></i>
                              </h6>
                            </td>
                          </tr>
                    ...
                    <div class="scroll-widget">
                      <div class="latest-update-box">
                        <div class="row pt-20 pb-30">
                          <div class="col-auto text-right update-meta pr-0">
                            <img
                              src="../img/users/4.jpg"
                              alt="user image"
                              class="rounded-circle img-40 align-top mr-15 update-icon"
                            />
                          </div>
                          <div class="col pl-5">
                        ...
                        <div class="row pb-30">
                          <div class="col-auto text-right update-meta pr-0">
                            <i
                              class="ik ik-check fw-600 bg-green update-icon"
                            ></i>
                          </div>
                          <div class="col pl-5">
                      ...
                      <div class="latest-update-box">
                        ...
                        <div class="row pb-30">
                          ...
                          <div class="col pl-5">
                            ...
                            <p class="text-muted mb-0">
                              Lorem ipsum dolor sit ipsum amet,
                              <a href="#!" class="text-green"> More</a>
                            </p>
                          </div>
                        </div>
                        <div class="row pb-30">
              ...
              <div class="col-xl-4 col-md-6">
                <div class="card">
                  ...
                  <div class="card-block widget-last-task">
                    <p class="mb-10">
                      New Dashboard
                      <span class="float-right text-muted f-14"
                        >5 Mins ago</span
                      >
                    </p>
                    <ul class="list-unstyled mb-20">
                      <li class="d-inline-block">
                        <img
                          src="../img/users/2.jpg"
                          alt="user-image"
                          class="rounded-circle img-30 mr-15"
                          data-toggle="tooltip"
                          data-placement="top"
                  ...
                  <div class="card-block">
                    <div class="row mb-20 received-chat">
                      ...
                      <div class="col">
                        ...
                        <p class="text-muted mb-0">
                          <i class="fa fa-clock-o mr-10"></i>10:20am
                        </p>
                      </div>
                    </div>
